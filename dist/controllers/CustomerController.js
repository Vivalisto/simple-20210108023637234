...
var CustomerController = /** @class */ (function () {
    ...
    CustomerController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var user, stageRequest, customers, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, customerService_1.default.create(stageRequest)];
                    case 2:
                        customers = _a.sent();
                        helper_1.default.sendResponse(res, HttpStatus.OK, { customers: customers });
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
    ...
    CustomerController.prototype.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var user, customers, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = req.userId;
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, customerService_1.default.get(user)];
                    case 2:
                        customers = _a.sent();
                        helper_1.default.sendResponse(res, HttpStatus.OK, { customers: customers });
                        return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, customerService_1.default.getById(id)];
                    case 2:
                        customers = _a.sent();
                        helper_1.default.sendResponse(res, http_status_1.default.OK, { customers: customers });
                        return [3 /*break*/, 4];
                    case 3:
                        error_3 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, customerService_1.default.update(id, stageUpdate)];
                    case 2:
                        user = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, customerService_1.default.delete(id)];
                    case 2:
                        _a.sent();
                        helper_1.default.sendResponse(res, http_status_1.default.OK, 'customers deletado com sucesso');
                        return [3 /*break*/, 4];
                    case 3:
                        error_5 = _a.sent();
