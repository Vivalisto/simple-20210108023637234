...
var UserAccessSchema = new mongoose.Schema({
    group: {
        type: String,
        default: access_control_enum_1.GroupType.Autonomo,
        required: true,
        uppercase: true,
    ...
    profile: {
        type: String,
        default: access_control_enum_1.ProfileType.Master,
        uppercase: true,
        required: true,
...
var UserSchema = new mongoose.Schema({
    ...
    situation: {
        type: String,
        default: user_situation_enum_1.UserSituation.Ativo,
        enum: Object.values(user_situation_enum_1.UserSituation),
    },
    isBroker: {
        type: Boolean,
        default: true,
    ...
    rules: {
        ...
        default: { group: access_control_enum_1.GroupType.Autonomo, profile: access_control_enum_1.ProfileType.Master },
    },
    organization: {
        type: mongoose.Schema.Types.ObjectId,
        ref: 'organization',
